        ...
        child: Column(
          ...
          children: [
            ...
            _buildUsageCard(
              ...
              percentage:
                  double.tryParse(_usageStats['readsPercentage'] ?? '0') ?? 0,
              icon: Icons.book,
              color: Colors.blue,
            ),
            ...
            _buildUsageCard(
              ...
              percentage:
                  double.tryParse(_usageStats['writesPercentage'] ?? '0') ?? 0,
              icon: Icons.edit,
              color: Colors.green,
            ),
            ...
            _buildUsageCard(
              ...
              percentage:
                  double.tryParse(_usageStats['deletesPercentage'] ?? '0') ?? 0,
              icon: Icons.delete,
              color: Colors.red,
            ),
            ...
            _buildUsageCard(
              ...
              percentage:
                  double.tryParse(_usageStats['uploadsPercentage'] ?? '0') ?? 0,
              icon: Icons.upload,
              color: Colors.orange,
            ),
            ...
            _buildUsageCard(
              ...
              percentage:
                  double.tryParse(_usageStats['downloadsPercentage'] ?? '0') ??
                      0,
              icon: Icons.download,
              color: Colors.purple,
            ),
            ...
            _buildUsageCard(
              ...
              percentage: double.tryParse(
                      _usageStats['authenticationsPercentage'] ?? '0') ??
                  0,
              icon: Icons.person,
              color: Colors.teal,
              isMonthly: true,
